...
const BreadCrumbs = () => {
  ...
  return (
    <div className="md:flex gap-1 hidden">
      <Link
        href="/dashboard"
        className="flex items-center justify-center hover:text-red-900 font-salt transition-all duration-100 ease-in-out font-bold text-xl ml-3"
      >
        Folders
      </Link>
      <p className="font-salt font-bold text-xl px-2">&gt;</p>
      <button
        onClick={() => router.back()}
